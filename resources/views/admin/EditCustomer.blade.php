...
<body class="bg-[#380606] flex justify-center min-h-screen relative tracking-wider">
    ...
    <div class="relative z-10 bg-black bg-opacity-50 p-6 shadow-lg rounded-md my-10 w-full max-w-xl">
        <h1 class="text-2xl text-white text-center mb-2">Edit Data Customer</h1>
        <form action="/register" method="POST" class="space-y-4">
            ...
            <div class="text-center">
                <button type="submit" class="bg-yellow-600 hover:bg-yellow-500 text-white tracking-wider rounded-md px-4 py-2">Register</button>
            </div>
        </form>
    </div>
</body>
