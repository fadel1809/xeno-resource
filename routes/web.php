...
Route::post('/admin/{id}/register-customer',[adminController::class,'registerUser'])->name('admin.register.customer.post');

Route::get('/admin/{id}/edit-customer/{customer}',[adminController::class,'showEditCustomerPage'])->name('admin.edit.customer');
Route::put('/admin/{id}/edit-customer/{customer}',[adminController::class,'editUser'])->name('admin.edit.customer.put');
...
Route::post('/admin/{id}/track-customer/{customer}/add',[adminController::class,'addOrder'])->name('admin.add.order.post');

Route::get('/admin/{id}/track-customer/{customer}/edit/{orderId}',[adminController::class,'showEditOrderPage'])->name('admin.edit.order');
Route::put('/admin/{id}/track-customer/{customer}/edit/{orderId}',[adminController::class,'editOrder'])->name('admin.edit.order.put');
...
Route::post('/admin/{id}/track-customer/{customer}/detail-order/{orderId}/add',[adminController::class,'addDetailOrder'])->name('admin.add.detail.order.post');
...
Route::put('/admin/{id}/track-customer/{customer}/detail-order/{orderId}/edit/{orderDetailId}',[adminController::class,'editDetailOrder'])->name('admin.edit.detail.order.put');
